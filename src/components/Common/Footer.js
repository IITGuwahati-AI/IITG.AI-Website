				...
				<div class="container">
					<div class="row ">
						<div class="col-md-4 text-center text-md-left ">
							...
							<div class="py-2">
								<h3 class="my-4 text-white">Developed by </h3> <a href="https://www.linkedin.com/in/vishisht-priyadarshi-34068b179/"> Vishisht Priyadarshi</a>, <a href="https://in.linkedin.com/in/shivanshmishra">Shivansh Mishra</a> & <a href="https://in.linkedin.com/in/gourav2k">Gourav Kumar</a>
						...
						<div class="col-md-4 text-white my-4 text-center text-md-left ">
							...
							<div class="py-2">
								...
								<a href="https://github.com/IITGuwahati-AI"><i class="fab fa-github fa-2x text-white mx-2"></i></a>
								<a href="https://twitter.com/iitgai"><i class="fab fa-twitter fa-2x text-info mx-3"></i></a>
								<a href="https://www.instagram.com/iitg.ai"><i class="fab fa-instagram fa-2x text-white mx-3"></i></a>
							</div>
						</div>
					</div>  
				</div>
